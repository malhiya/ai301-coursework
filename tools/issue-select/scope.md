...
I have used Python, JavaScript/TypeScript, React, and some Java in coursework and projects. For this first issue I want something simple and well-scoped: a tier 1 or tier 2 issue, nothing too complicated. I would rather
avoid issues that need Docker or a complex environment setup, or that need paid accounts or API keys to test.
